      ...
      >
        ...
        <div className={cn(
          ...
          <Link href="/dashboard" className="flex items-center gap-3">
            <div
              className="flex items-center justify-center w-10 h-10 rounded-xl flex-shrink-0 shadow-[0_0_20px_rgba(14,165,233,0.3)]"
            ...
            {!collapsed && (
              <div className="flex flex-col leading-tight">
                <span className="text-[1.05rem] font-extrabold text-[#f0f9ff] tracking-tight"
                  style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  LogisticsPro
                </span>
                <span className="text-[0.6rem] text-[#38bdf8] uppercase tracking-[0.8px] font-medium">
                  Enterprise
                </span>
              </div>
            )}
