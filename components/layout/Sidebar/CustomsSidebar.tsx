...
import {
  ...
  LayoutDashboard, FileText, Clock, CheckCircle, AlertCircle, Search,
  BadgeCheck, AlertTriangle, Globe, Folder, Receipt, Award,
  BarChart2, Bell,
} from 'lucide-react';
...
const customsMenu: MenuItem[] = [
  ...
  },
  {
    ...
    icon: FileText,
    children: [
      { id: 'declarations', label: 'Declarations', icon: FileText, href: '/customs/declarations' },
      { id: 'pending', label: 'Pending Clearance', icon: Clock, href: '/customs/pending' },
      { id: 'cleared', label: 'Cleared Shipments', icon: CheckCircle, href: '/customs/cleared' },
      { id: 'holds', label: 'Holds & Queries', icon: AlertCircle, href: '/customs/holds' },
    ],
  },
  {
    id: 'compliance',
    ...
    icon: BadgeCheck,
    children: [
      { id: 'hs-codes', label: 'HS Code Lookup', icon: Search, href: '/customs/hs-codes' },
      { id: 'licenses', label: 'Import/Export Licenses', icon: BadgeCheck, href: '/customs/licenses' },
      { id: 'dg', label: 'Dangerous Goods', icon: AlertTriangle, href: '/customs/dg' },
      { id: 'restrictions', label: 'Country Restrictions', icon: Globe, href: '/customs/restrictions' },
    ],
  },
  {
    id: 'documents',
    ...
    icon: Folder,
    children: [
      { id: 'customs-docs', label: 'Customs Documents', icon: Folder, href: '/customs/documents' },
      { id: 'invoices', label: 'Commercial Invoices', icon: Receipt, href: '/customs/documents/invoices' },
      { id: 'coo', label: 'Certificates of Origin', icon: Award, href: '/customs/documents/coo' },
    ],
  },
  {
    id: 'reports',
    ...
    icon: BarChart2,
    children: [
      { id: 'clearance-reports', label: 'Clearance Reports', icon: BarChart2, href: '/customs/reports' },
    ],
  },
  {
    id: 'misc',
    ...
    icon: Bell,
    children: [
      { id: 'notifications', label: 'Notifications', icon: Bell, href: '/customs/notifications' },
    ],
  },
];
