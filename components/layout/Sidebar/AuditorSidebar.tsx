...
import { auditorMenu, type AuditorMenuItem } from '@/data/auditor-menu';
import {
...
export function AuditorSidebar() {
  ...
  const isMenuActive = (item: AuditorMenuItem): boolean => {
    if (item.href) {
  ...
  const renderMenuItems = (items: AuditorMenuItem[], level = 0) => {
          ...
          >
            ...
            >
              ...
              <span className="flex items-center gap-1.5 mt-0.5">
                ...
                <Badge variant="outline" className="text-[0.5rem] px-1 py-0 h-4 border-[rgba(148,163,184,0.4)] text-[rgba(148,163,184,0.7)] font-medium">
                  Read Only
                </Badge>
              </span>
            </div>
