...
import {
  ...
  LayoutDashboard, Box, TrendingUp, AlertCircle, Truck, Users,
  Map, FileText, Bell,
} from 'lucide-react';
...
const opsMenu: MenuItem[] = [
  ...
  },
  {
    ...
    icon: Box,
    children: [
      { id: 'shipments-list', label: 'Shipments', icon: Box, href: '/ops/shipments' },
      { id: 'container-tracking', label: 'Container Tracking', icon: Box, href: '/ops/container-tracking' },
      { id: 'sla-alerts', label: 'SLA Alerts', icon: AlertCircle, href: '/ops/sla-alerts' },
    ],
  },
  {
    id: 'dispatch',
    ...
    icon: Truck,
    children: [
      { id: 'dispatch-board', label: 'Dispatch Board', icon: Truck, href: '/ops/dispatch' },
      { id: 'drivers', label: 'Drivers', icon: Users, href: '/ops/drivers' },
      { id: 'fleet', label: 'Fleet', icon: TrendingUp, href: '/ops/fleet' },
      { id: 'live-map', label: 'Live Map', icon: Map, href: '/ops/live-map' },
      { id: 'trip-history', label: 'Trip History', icon: TrendingUp, href: '/ops/fleet/trips' },
    ],
  },
  {
    id: 'documents',
  ...
  },
  {
    ...
    icon: Bell,
    children: [
      { id: 'notifications', label: 'Notifications', icon: Bell, href: '/ops/notifications' },
    ],
  },
];
        ...
        <div className={cn(
          ...
          {!collapsed && user && (
            <div className="mb-2.5 px-3 py-2 rounded-[10px] bg-[rgba(255,255,255,0.04)] border border-[rgba(14,165,233,0.1)]">
              ...
              <p className="text-[0.68rem] text-[#38bdf8] uppercase tracking-[0.5px] font-medium">
                {user.role}
              </p>
            </div>
          )}
          ...
          <Tooltip>
            ...
            {collapsed && (
              <TooltipContent
                side="right"
                sideOffset={12}
                className="bg-[#0d1f38] text-[#e0f2fe] border border-[rgba(14,165,233,0.2)]"
              >
                Logout
              </TooltipContent>
            )}
