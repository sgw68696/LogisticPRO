...
export default function LicensesCompliancePage() {
  ...
  return (
    <PageWrapper
      ...
      description="Read-only license compliance records"
      actions={
    ...
    >
      ...
      {loading ? (
        <LoadingState rows={6} message="Loading license compliance records..." />
      ) : records.length === 0 ? (
        <EmptyState
          ...
          description={
            search || statusFilter !== 'All'
              ...
              : 'No license compliance records are available for audit review.'
          }
          action={
            (search || statusFilter !== 'All') ? (
              <Button
        ...
        <DataTable
          ...
          columns={columns}
          pageSize={10}
          emptyMessage="No license records match your criteria."
        />
      )}
    </PageWrapper>
  );
